...
class OIVSCodeSer0501 {
    constructor(options = {}) {
        ...
        this.API_ENDPOINT = "https://oi-vscode-server-0501.onrender.com/v1/chat/completions";
...
export async function oivscode0501(messages, model) {
    try {
        const client = new OIVSCodeSer0501();
